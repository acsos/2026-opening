...
<div class="organizing-committee" style="display:grid; grid-template-columns:repeat(8, 1fr); gap:0em 0em; width:98%; margin:.2em auto 0; font-family:inherit;">
  ...
  <div style="text-align:center; font-size:20px; line-height:1.1;"><img src="https://2026.acsos.org/getProfileImage/gianlucaaguzzi/2bb4627f-ccd6-46c4-b64f-84927839816d/small-avatar?1783975971000" alt="Gianluca Aguzzi" style="width:4.1em; height:4.1em; object-fit:cover; border-radius:50%; border:3px solid #f6d365;"><br><b>Gianluca Aguzzi</b><br><small>Web Chair</small></div>
...
<div style="display:grid; grid-template-columns:repeat(4, 1fr); gap:1em; width:97%; margin:.4em auto 0; font-family:inherit;">
  <div style="padding:.5em .6em; border-top:5px solid #f6d365; border-radius:.35em; background:rgba(66,54,27,.86); text-align:center; min-height:20em;">
  ...
  <div style="padding:.5em .6em; border-top:5px solid #48c6ef; border-radius:.35em; background:rgba(16,48,81,.86); text-align:center; min-height:20em;">
  ...
  <div style="padding:.5em .6em; border-top:5px solid #c59bff; border-radius:.35em; background:rgba(42,33,76,.86); text-align:center; min-height:20em;">
  ...
  <div style="padding:.5em .6em; border-top:5px solid #8ee3a8; border-radius:.35em; background:rgba(24,67,53,.86); text-align:center; min-height:20em;">
...
# Moving in the Campus

* Floors, rooms, water
* Water
* Map and Link/QR to map
